      ...
      <AuthProvider>
        <BrowserRouter>
              ...
              <Routes>
                ...
                <Route path="/adjustments/criticallevel" element={<CriticalLevel /> } />
                <Route path="/reports/productanalytics" element={<ProductAnalytics />} />
                <Route path="/reports/earninganalytics" element={<EarningAnalytics />} />
                <Route path="/reports/supplieranalytics" element={<SupplierAnalytics />} />
                <Route path="/reports/productreports" element={<ProductReports />} />
                <Route path="/reports/earningreports" element={<EarningReports />} />
                <Route path="/reports/supplierreports" element={<SupplierReports />} />
