...
import { AiOutlineCalendar, AiOutlineShoppingCart, AiOutlineAreaChart, AiOutlineBarChart, AiOutlineStock, AiOutlineDashboard, AiFillDashboard } from 'react-icons/ai';
import { FiShoppingBag, FiEdit, FiPieChart, FiBarChart, FiCreditCard, FiStar, FiShoppingCart } from 'react-icons/fi';
import { BsKanban, BsBarChart, BsBoxSeam, BsCurrencyDollar, BsShield, BsChatLeft, BsFillArchiveFill, BsPerson, BsPersonBoundingBox, BsFilePerson, BsGraphUp, BsClipboardData, BsPeople, BsPeopleFill, BsFileBarGraphFill, BsArrowLeftRight } from 'react-icons/bs';
import { BiArchive, BiArchiveIn, BiBuildings, BiCapsule, BiClipboard, BiCoinStack, BiColorFill, BiHistory, BiListCheck, BiListOl, BiListPlus, BiListUl, BiPointer, BiReceipt, BiStore } from 'react-icons/bi';
import { IoIosArrowDropdownCircle, IoMdArrowDropdown, IoMdContacts, IoMdListBox } from 'react-icons/io';
import { RiBarChartBoxFill, RiBuilding3Fill, RiBuilding4Fill, RiCapsuleFill, RiClipboardFill, RiCoinsFill, RiContactsFill, RiContactsLine, RiHistoryFill, RiListOrdered, RiShieldUserFill, RiStockLine, RiStore3Fill } from 'react-icons/ri';
import { MdArrowDropDown, MdOutlineInventory, MdOutlinePersonalInjury, MdOutlineSupervisorAccount, MdPayment, MdPersonOutline, MdReport, MdSpaceDashboard } from 'react-icons/md';
import { HiAdjustments, HiClipboardList, HiDocumentReport, HiOutlineReceiptTax, HiOutlineRefresh} from 'react-icons/hi';
import { TbArrowsRightLeft, TbDiscount2, TbReportAnalytics, TbReportMoney } from "react-icons/tb";
import { TiTick } from 'react-icons/ti';
import { FaFileInvoice, FaJediOrder } from 'react-icons/fa';
import { HiInboxStack } from 'react-icons/hi2';
import { GiCoins, GiCoinsPile, GiLouvrePyramid, GiPaper } from 'react-icons/gi';
import { GrGraphQl, GrLocation, GrTransaction } from 'react-icons/gr';
...
import { Payments, Products } from '../pages';

export const gridOrderImage = (props) => (
  <div>
    <img
      className="rounded h-20 md:ml-3"
...
export const gridOrderStatus = (props) => (
  <button
    ...
    className="text-black py-1 px-2 capitalize rounded-md text-md"
  >
    {props.Status}
  </button>
);
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        //     parent: 2,
        //     id: 24,
        //     path: 'inventory/accounts_payable',
        //     name: 'A/P invoice',
        //     icon: <FaFileInvoice />,
        //   },
        // ],
      ...
      },
      {
        ...
        subMenuItems:  [
          ...
          // },
          {
            parent: 1,
            id: 10,
            path: 'adjustments/criticallevel',
            name: 'critical level',
      ...
      },
      {
        ...
        subMenuItems:  [
          ...
          },
          {
            parent: 1,
            id: 12,
            path: '/reports/earninganalytics',
            name: 'earning analytics',
            icon: <TbReportMoney />,
          },
          {
            parent: 1,
            id: 13,
            path: '/reports/productanalytics',
          ...
          },
          {
            parent: 1,
            id: 14,
            path: '/reports/supplieranalytics',
