  ...
  const productGrid = [
    {
      ...
      render: (text, record) => {
        return <span style={{ textTransform: 'capitalize' }}>
                  ...
                  {URL.createObjectURL("https://cs1100320004a5f1cb9.blob.core.windows.net/productimage/1669312163937-Zm9yIGNlbGVicmF0aW5nIHdpdGggdXMucG5n.png");}
               </span>
      }
    },
    {
    ...
    <div className='md:m-10 mt-20 mx-8'>
      ...
      <div className='m-2 md:m-10 p-2 md:px-10 pb-5 bg-white rounded-xl shadow-md'>
        ...
        <div className='flex w-full h-12 mt-2'>
          <p className='my-auto w-auto sm:w-34 md:w-72 px-4 font-bold'>Masterlist</p>
