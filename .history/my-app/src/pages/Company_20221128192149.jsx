        ...
        <div className='m-20 my-auto overflow-auto bg-white rounded'>
            ...
            <div className="flex w-full my-5 textboxes">
               <p className='w-32 my-auto font-display'>Company Date Established:</p>
                <DatePicker className='w-full my-auto' name="date_established" value={moment(company.date_established)||null} placeholder="No Value" disabled={EDorUPD === "Edit"? true:false} onChange={onChangeCompany}/>
            </div>
