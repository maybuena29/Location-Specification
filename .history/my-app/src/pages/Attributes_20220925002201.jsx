...
const Attributes = () => {
  ...
  useEffect(() => {
    Axios.get("http://localhost:3001/api/attribute/get").then((response)=>{
      ...
      <Header title='Attribute'/>
        ...
        <div className='m-2 md:m-10 p-2 md:px-10 pb-5 bg-white rounded-xl shadow-md'>
          ...
          <div className='m-2 my-auto bg-white rounded overflow-auto'>
            <Table bordered className='mt-14' columns={attrTblGrid} dataSource={aList} onChange={onChange}></Table>
          </div>
