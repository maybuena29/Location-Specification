  ...
  //For the column of the table
    ...
    const employeeTblGrid: ColumnsType<DataType> = [
      ...
      },
      {
        ...
        sortDirections: ['descend', 'ascend'],
        render: (text, record) => {
          return <p style={{color: record.Status === 'active' ? 'green': 'red', textTransform: 'capitalize'}} className='font-semibold'>{text}</p>
        }
      },
      {
        key: 'userID',
          ...
          {/* <div className='relative w-full'>
            ...
            <Modal title={modal.Title} visible={modal.Visible} onOk={handleOk} onCancel={handleOk}
                  ...
                  <p className='ml-5'>User Roles Informations</p>
                    <div>
                      <Input className='rounded-sm' value={rolesList.userName||''} name="userName" placeholder="Roles Name" onChange={onChangeEmp} />
                    </div>

                    <div>
                      <Input className='rounded-sm' value={rolesList.userContact||''} name="userContact"placeholder="Roles Contact" onChange={onChangeEmp}/>
                    </div>

                    <div>
                      <Input className='rounded-sm' value={rolesList.userAddress|| ''} name="userAddress"placeholder="Roles Address" onChange={onChangeEmp}/>
                    </div>

                    <div>
                      <Input className='rounded-sm' value={rolesList.userRoleID|| ''} name="userRoleID" placeholder="Roles Role" onChange={onChangeEmp}/>
                    </div>
                    <div>
                      <p className='ml-5'>User Roles Credentials</p>
                    </div>
                    <div>
                      <Input className='rounded-sm' value={rolesList.userUsername|| ''} name="userUsername" disabled={btnType === "Update"? true:false} placeholder="Roles Username" onChange={onChangeEmp} />
                    </div>

                    <div>
                      <Input className='rounded-sm' type="password" value={rolesList.userPassword|| ''} name="userPassword" placeholder="Roles Password" disabled={OnOff} onChange={onChangeEmp}  />
