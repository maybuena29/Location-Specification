...
const { Search } = Input;
  ...
  const [soldCounter,setsoldCounter]=useState(1);
    ...
    interface TransacTableData {
      ...
      productReqPres:string ;
      productSKU:string ;
      inventoryQuantity:number ;
      inventoryDateExp:date ;
      inventoryDateManu:date ;
      inventoryStatus:string ;
      TransacSoldQty:number;
    ...
    const setTotal = (data, index) => {
      ...
      data[index]["TotalPrice"] = Number(
        data[index]["TransacSoldQty"] * data[index]["productPrice"]
      );
    };
  ...
  const selectionColumns = [
    ...
    { 
      ...
      render: (text, record) => {
        return (
          <Input value={text} onChange={onInputChange("TransacSoldQty", record.productID)} />
        )
  ...
  const ordSelListTable: TransacTableData[]=[
    obtainSelectedOrder.map(({body,...item}) => ({
      ...item,
          ...
          {/* <div className='relative w-full'>
            ...
            <div className='flex flex-col md:flex-row w-full min-w-screen justify-center items-center'>
              ...
              <div className="flex md:mr-10  flex-col gap-4 justify-center w-full md:w-1/2 p-0 sm:w-full">
                <div className="">
                    <Table columns={selectionColumns} dataSource={ordSelListTable} pagination={false}
