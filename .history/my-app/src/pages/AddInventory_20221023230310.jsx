...
const AddInventory = () => {
  ...
  const retrievedDateManu = moment(inventoryDateManu, dateFormat).add(1,'hours');
          ...
          <div className='flex flex-col md:flex-row w-full min-w-screen justify-center items-center'>
            ...
            <div className="flex  flex-col gap-4 justify-center w-full md:w-1/2 p-0 sm:w-full">
              ...
              <div className="flex textboxes w-full">
                  ...
                  <DatePicker className='my-auto w-full' disabledDate = {disableFutureDt} format={"YYYY-MM-DD"} value={id? moment.(inventoryDateManu,dateFormat): ""} placeholder="Date Manufactured" allowClear={false}  disabled={productSKU==="Choose/Search SKU"? true:false } onChange={handleIDateManuChange}/>
              </div>
