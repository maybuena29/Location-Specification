...
`;
  ...
  const fetchDailySales = () => {
    fetch(`${mainApi}/api/reports/get/itemsales/daily/datanl`)
  ...
  const fetchWeeklySales = () => {
    fetch(`${mainApi}/api/reports/get/itemsales/weekly/datanl`)
      .then((response) => response.json())
  ...
  const fetchMonthlySales = () => {
    fetch(`${mainApi}/api/reports/get/itemsales/monthly/datanl`)
      .then((response) => response.json())
  ...
  const fetchYearlySales = () => {
    fetch(`${mainApi}/api/reports/get/itemsales/yearly/datanl`)
      .then((response) => response.json())
  ...
  const WeeklyProductTblGrid: ColumnsType<DataType> = [
    {
      title: 'Month',
      dataIndex: 'Month',
      defaultSortOrder: 'descend',
  ...
  const MonthlyProductTblGrid: ColumnsType<DataType> = [
    {
      title: 'Year',
      dataIndex: 'Year',
      defaultSortOrder: 'descend',
  ...
  const YearlyProductTblGrid: ColumnsType<DataType> = [
          ...
          <div className='m-2 md:my-10 p-2 md:px-10 pb-5 bg-white rounded-xl shadow-md w-full'>
            ...
            <div className='my-auto bg-white w-full rounded p-0 overflow-scroll'>
              <Tabs defaultActiveKey="1" className='w-full' onChange={tabChange}  size='small'>
                ...
                <Table bordered pagination={{ defaultPageSize: 10, showSizeChanger: true, pageSizeOptions: ['10', '25', '50', '100']}} columns={WeeklyProductTblGrid} dataSource={weeklyOrders}
                rowKey={(record,index)=>index}></Table>
                </TabPane>
                <TabPane tab='Monthly' key='3'>
                <Table bordered pagination={{ defaultPageSize: 10, showSizeChanger: true, pageSizeOptions: ['10', '25', '50', '100']}} columns={MonthlyProductTblGrid} dataSource={monthlyOrders} 
                rowKey={(record,index)=>index}></Table>
                </TabPane>
                <TabPane tab='Yearly' key='4'>
                <Table bordered pagination={{ defaultPageSize: 10, showSizeChanger: true, pageSizeOptions: ['10', '25', '50', '100']}} columns={YearlyProductTblGrid} dataSource={yearlyOrders} 
                rowKey={(record,index)=>index}></Table>
                </TabPane>
              </Tabs>
