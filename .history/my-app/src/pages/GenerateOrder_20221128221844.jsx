...
const GenerateOrder = () => {
  ...
  const fetchInventoryItems = async () => {
    const { data } = await Axios.get(`${mainApi}/api/inventory/get/prod/active`, {signal: abortController.signal});
    const { datas } = await Axios.get(`${mainApi}/api/generateOrder/get/verify'`, {signal: abortController.signal}).catch((err)=>{
