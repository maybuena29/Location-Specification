      ...
      <Header title='Accounts'/>
        ...
        <div className='m-2 md:m-10 p-2 md:px-10 pb-5 bg-white rounded-xl shadow-md'>
          ...
          {/* <div className='relative w-full'>
            ...
            <Modal title={modal.Title} visible={modal.Visible} onOk={handleOk} onCancel={handleOk}
                  ...
                  <p className='ml-5'>User Employee Informations</p>
                    <div>
                      <Input className='rounded-sm' value={employeeList.userName||''} placeholder="Employee Name" onChange={onChangeEmp} />
                    </div>

                    <div>
                      <Input className='rounded-sm' value={employeeList.userContact||''} placeholder="Employee Contact" onChange={onChangeEmp}/>
                    </div>

                    <div>
                      <Input className='rounded-sm' value={employeeList.userAddress|| ''} placeholder="Employee Address" onChange={onChangeEmp}/>
                    </div>

                    <div>
                      <Input className='rounded-sm' value={employeeList.userRoleID|| ''} placeholder="Employee Role" onChange={onChangeEmp}/>
                    </div>
                    <div>
                      <p className='ml-5'>User Employee Credentials</p>
                    </div>
                    <div>
                      <Input className='rounded-sm' value={employeeList.userUsername|| ''} placeholder="Employee Username" onChange={onChangeEmp} />
                    </div>

                    <div>
                      <Input className='rounded-sm' type="password" value={employeeList.userPassword|| ''} placeholder="Employee Password" onChange={onChangeEmp} />
                        {btnType==="Update"?<Checkbox>Reset?</Checkbox>:null}
                    </div>         
                    
                    <div>
                      <Select className='w-full rounded-sm' placeholder="Employee Status" value={status} onChange={onChangeEmp}>
          ...
          <div className='m-2 my-auto bg-white rounded overflow-auto'>
            <Table bordered className='mt-14' columns={employeeTblGrid} dataSource={employeeList} rowKey="userID" onChange={onChange}></Table>
          </div>
