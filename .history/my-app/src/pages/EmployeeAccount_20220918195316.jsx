...
const openNotif = (type) => {
  if(type === 'success'){
    notification[type]({
      message: 'SUCCESS!',
      description: 'EmployeeAccount Added Successfully.',
      duration: 4,
    ...
    notification[type]({
      message: 'SUCCESS!',
      description: 'EmployeeAccount Removed Successfully.',
      duration: 4,
      style: {borderRadius: '5px', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'},
    });
  }else if(type === 'error'){
    ...
    notification[type]({
      message: 'SUCCESS!',
      description: 'EmployeeAccount Updated Successfully.',
      duration: 4,
      style: {borderRadius: '5px', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'},
    });
  }
...
const EmployeeAccount = () => {
  ...
  const showAddModal = () => {
    setBtnType('Add');
    setModal({Title: 'Add EmployeeAccount', Visible: true});
  };
  ...
  const showUpdateModal = () => {
    setBtnType('Update');
    setModal({Title: 'Update EmployeeAccount', Visible: true});
  };
                ...
                <Modal title={modal.Title} visible={modal.Visible} onOk={handleOk} onCancel={handleOk}
                  ...
                  <div className='flex flex-col gap-4'>
                    <div>
                      ...
                      <Input className='rounded-sm' value={brandName || ''} placeholder="EmployeeAccount Name"
                        onChange={(e) => {
            ...
            <div className='absolute right-0 mt-1'>
                <Input.Group compact className='-right-4 md:-right-16 sm:-right-6'>
                  <Select placeholder='Column' style={{ border: 'none' }} onChange={(e) => setSearch({term: search.term,type: e})} value={search.type}>
                    <Option value="EmployeeAccount">EmployeeAccount</Option>
