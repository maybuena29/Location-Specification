...
const AddRoles = () => {
  ...
  const retrievedDateExp = moment.utc(inventoryDateExp, dateFormat);
  ...
  useEffect(()=>{
    ...
    Axios.get(`${mainApi}/api/inventory/getskus`).then((response)=>{
      setobtainedSKU(response.data);
    
        if(id){
          Axios.get(`${mainApi}/api/inventory/get/${id}`).then((response)=>{
  ...
  function searchSKU(getSKU){ 
    Axios.get(`${mainApi}/api/inventory/get/sku/${getSKU}`).then((response)=>{
      setPName(response.data.productName);
      setPDescription(response.data.productDescription);
      setPAttribute(response.data.productAttribute);
      setPAttrValue(response.data.productAttrValue);
  ...
  function submitButton(event){
    if(productSKU === 'Choose/Search SKU'){
    ...
    else if(!moment(inventoryDateExp, 'YYYY-MM-DD').isValid()){
      ...
      if (id){
        // Axios.put(`${mainApi}/api/inventory/update/${id}`,{
