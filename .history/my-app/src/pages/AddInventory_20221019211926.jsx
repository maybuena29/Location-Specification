          ...
          <div className='flex flex-col md:flex-row w-full min-w-screen justify-center items-center'>
            ...
            <div className="flex  flex-col gap-4 justify-center w-full md:w-1/2 p-0 sm:w-full">
              ...
              <div className="flex textboxes w-full">
                  ...
                  <DatePicker className='my-auto w-full' disabledDate = {disableFutureDt} format={"YYYY-MM-DD"} value={id? retrievedDateManu : inventoryDateManu || ''} placeholder="Date Manufactured"   disabled={productSKU==="Choose/Search SKU"? true:false } onChange={handleIDateManuChange}/>
              </div>

              <div className="flex textboxes w-full">
                  <p className='my-auto font-display w-32'>Date Expiration:</p>
                  <DatePicker className='my-auto w-full' disabledDate = {disablePastDt} format={"YYYY-MM-DD"} value={id? retrievedDateExp : inventoryDateExp || ''} placeholder="Date Expiration"   disabled={productSKU==="Choose/Search SKU"? true:false} onChange={handleIDateExpChange}/>
              </div>
