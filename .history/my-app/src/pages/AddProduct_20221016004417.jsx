          ...
          <div className='flex flex-col md:flex-row w-full min-w-screen justify-center items-center'>
            ...
            <div className="flex md:mr-10  flex-col gap-4 justify-center w-full md:w-1/2 p-0 sm:w-full">
                ...
                <div className="flex textboxes w-full">
                  ...
                  src={id? "http://localhost:3001/uploads/productImages/1665757870239-289578215_572855034447304_4728205654788097477_n.jpg" : URL.createObjectURL(productImage): null}
                     />
                    <input type="file" name="productImage" accept=".png, .jpg, .jpeg" onChange={(e)=> setPImage(e.target.files[0])} /> 
                </div>
                <div className="flex textboxes w-full">
