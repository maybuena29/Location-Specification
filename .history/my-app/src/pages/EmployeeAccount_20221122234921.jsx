    ...
    const employeeTblGrid: ColumnsType<DataType> = [
      ...
      },
      {
        ...
        render:(_,record) =>
          <Space align='end'>
            {/* For Update */}
            <Button style={{backgroundColor: '#83D2FF'}} onClick={()=> {showDataToModal(record.userID);} className='text-black py-1 pl-2.5 pr-0 h-9 rounded inline-flex items-center my-auto w-10 sm:w-10 md:w-10 md:p-3 md:pl-3 sm:pr-2.5'>
