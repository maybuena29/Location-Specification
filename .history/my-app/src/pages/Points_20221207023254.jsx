  ...
  const fetchCustomerPoints = () =>{
   ...
   const fetchPointsHistory = () =>{
    ...
    const fetchVerify= async () => {
      await Axios.get(`${mainApi}/api/customer/account/get/verify`, {signal: abortController.signal}).then((response)=>{
  ...
  //For the column of the table
    ...
    const totalPointTblGrid: ColumnsType<DataType> = [
      ...
      },
      {
        ...
        sortDirections: ['descend', 'ascend'],
        render: (text, record) => {
          return <p style={{textTransform: 'capitalize'}}>{moment(text).format('YYYY-MM-DD, h:mm:ss A')}</p>
        }
      },
    ];
    ...
    <div className='md:m-10 mt-20 mx-8'>
      ...
      <div className='m-2 md:m-10 p-2 md:px-10 pb-5 bg-white rounded-xl shadow-md'>
        ...
        <div className='m-2 my-auto bg-white rounded overflow-auto'>
          <Table bordered className='mt-14' columns={totalPointTblGrid} dataSource={CPList} rowKey="PntCustID" onChange={onChange}></Table>
        </div>
      ...
      <div className='m-2 md:m-10 p-2 md:px-10 pb-5 bg-white rounded-xl shadow-md'>
        ...
        {/* For Table */}
        <div className='m-2 my-auto bg-white rounded overflow-auto'>
          <Table bordered className='mt-14' columns={pointHistoryTblGrid} dataSource={PHList} rowKey="OrderID" onChange={onChange}></Table>
        </div>
