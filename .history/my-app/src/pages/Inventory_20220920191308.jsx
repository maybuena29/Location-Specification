...
import { ordersData, contextMenuItems, ordersGrid, inventoryGrid, brandGrid } from '../data/dummy';
import { Header } from '../components';
import { NavLink,Link } from 'react-router-dom';
import { Button } from '@material-tailwind/react';
import { DataManager, UrlAdaptor } from "@syncfusion/ej2-data";
import  Axios  from 'axios';
import {Modal, Space,Table,notification, Input, Select,message,Upload} from 'antd';
      ...
      <Header title='Inventory'/>
        ...
        <div className='m-2 md:m-10 p-2 md:px-10 pb-5 bg-white rounded-xl shadow-md'>
          ...
          <div className='flex w-full h-12 mt-2'>
            <p className='my-auto px-4 font-semibold'>Inventory List</p>
            ...
            <div className='relative w-full'>
              <div className='absolute right-0 w-34'>
                ...
                <NavLink to={''}>
                  <Button type='button' onClick={()=>setModal({Visible:true})}size='sm' style={{backgroundColor: '#46E4AC'}} className='hover:bg-green-400 text-black py-1 pl-2 pr-0 h-10 rounded inline-flex items-center my-1 w-10 sm:w-10 md:w-auto md:p-4'>
                ...
                <Modal title={modal.Title} visible={modal.Visible} onOk={handleOk} onCancel={handleOk}
                  ...
                  <div className='flex flex-col gap-4'>
                    <div>
                      ...
                      <Upload accept='application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel'>
                ...
                <Modal title="View Product" visible={isModalVisible} onCancel={doneModal} centered width={1000} footer={null}>
                  ...
                  <div className="flex  flex-col gap-4 justify-center w-full md:w-1/2 p-0 sm:w-full">
                    ...
                    <div className="flex textboxes w-full">
                        ...
                        <Input className='my-auto' type="number" value={inventoryQuantity || ''} placeholder="Enter Inventory Quantity"   disabled/>
                    </div>
          ...
          <div className='m-2 my-auto bg-white rounded overflow-auto'>
            <Table bordered className='mt-14' columns={inventoryGrid} dataSource={invList}></Table>
          </div>
