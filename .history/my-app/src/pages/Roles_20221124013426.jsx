  ...
  //For the column of the table
    ...
    const rolesTblGrid: ColumnsType<DataType> = [
      ...
      
      {
        ...
        render:(_,record) =>
          <Space align='end'>
            <Button className='text-black py-1 pl-2.5 pr-0 h-9 rounded inline-flex items-center my-auto w-10 sm:w-10 md:w-32 md:p-4' style={{backgroundColor: "#46E4AC", borderRadius: 5}} onClick={()=>{navigate(`/users/roles/addroles/${record.userRoleID}`);}}>
