...
const Login = () => {
    return (
        <div className="relative flex flex-col justify-center min-h-screen overflow-hidden background-image: linear-gradient(to top, var(--tw-gradient-stops));">
            <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl shadow-rose-600/40 ring ring-2 ring-blue-600 lg:max-w-xl">
                ...
                <img className='w-16 center' src={med_icon}/>
                </h1>
                <form className="mt-6">
                    <div className="mb-2">
                        <label
