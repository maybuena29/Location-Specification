              ...
              <div className='absolute right-0 w-34'>
                ...
                <Modal title="View Product" visible={isModalVisible} onCancel={doneModal} centered width={1000} footer={null}>
                  ...
                  <div className="flex  flex-col gap-4 justify-center w-full md:w-1/2 p-0 sm:w-full">
                    ...
                    <div className="flex textboxes w-full">
                        <p className='my-auto font-display w-32'>EmployeeAccount Quantity:</p>
                        <Input className='my-auto' type="number" value={inventoryQuantity || ''} placeholder="Enter EmployeeAccount Quantity"   disabled/>
                    </div>
                    ...
                    <div className="flex textboxes w-full">
                        <p className='my-auto font-display w-32'>EmployeeAccount Status:</p>
