          ...
          <div className='flex w-full h-12 mt-2'>
            ...
            <div className='relative w-full'>
              <div className='absolute right-0 w-34'>
                ...
                <NavLink to={''}>
                  <Button type='button' onClick={()=>setIsModalVisible(true)}size='sm' style={{backgroundColor: '#46E4AC'}} className='hover:bg-green-400 text-black py-1 pl-2 pr-0 h-10 rounded inline-flex items-center my-1 w-10 sm:w-10 md:w-auto md:p-4'>
