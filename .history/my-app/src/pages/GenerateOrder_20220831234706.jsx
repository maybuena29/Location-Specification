  ...
  const invselectionColumns = [
    ...
    { 
      ...
      render: (text, record) => {
        ...
        <Button style={{backgroundColor: "#ED5264"}} className='text-black py-1 pl-2.5 pr-0 h-9 rounded inline-flex items-center my-auto w-10 sm:w-10 md:w-10 md:p-0 sm:pr-2.5' onClick={() => {
               -
            }}>
