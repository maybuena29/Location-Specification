          ...
          <div className='m-2 md:my-10 p-2 md:px-10 pb-5 bg-white rounded-xl shadow-md w-full'>
            ...
            <div className='my-auto bg-white w-full rounded p-0 overflow-scroll'>
              <Tabs defaultActiveKey="1" className='w-full' onChange={tabChange}  size='small'>
                ...
                <Table  bordered pagination={{ defaultPageSize: 10, showSizeChanger: true, pageSizeOptions: ['10', '25', '50', '100']}} columns={DailyProductTblGrid} dataSource={dailySupplier} 
                rowKey={(record,index)=>index} ></Table>
                </TabPane>
                <TabPane tab='Weekly' key='2'>
                <Table bordered pagination={{ defaultPageSize: 10, showSizeChanger: true, pageSizeOptions: ['10', '25', '50', '100']}} columns={WeeklyProductTblGrid} dataSource={weeklySupplier}
                rowKey={(record,index)=>index}></Table>
                </TabPane>
                <TabPane tab='Monthly' key='3'>
                <Table bordered pagination={{ defaultPageSize: 10, showSizeChanger: true, pageSizeOptions: ['10', '25', '50', '100']}} columns={MonthlyProductTblGrid} dataSource={monthlySupplier} 
                rowKey={(record,index)=>index}></Table>
                </TabPane>
                <TabPane tab='Yearly' key='4'>
                <Table bordered pagination={{ defaultPageSize: 10, showSizeChanger: true, pageSizeOptions: ['10', '25', '50', '100']}} columns={YearlyProductTblGrid} dataSource={yearlySupplier} 
                rowKey={(record,index)=>index}></Table>
                </TabPane>
              </Tabs>
