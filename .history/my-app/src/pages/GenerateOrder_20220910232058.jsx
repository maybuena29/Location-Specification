...
const GenerateOrder = () => {
  ...
  const handleDelete = (key) => {
    const newData = currentSelectedItem.filter((item) => item.key !== key);
    setCurrentSelectedItem(newData);
  ...
  const selectionColumns = [
    ...
    },
    {
      ...
      render: (text, record) => {
        return (
          <Button type="button" className="bg-red text-white" onClick={()=> record.key}> Delete
        </Button>
        )
      },
    },
