...
import { verify } from '../../../Server/controllers/reports.controller';
...
const SupplierReports = () => {
  ...
  const fetchTotalSupplier = async () => {
    await Axios.get(`${api}/api/reports/get/total/supplier`, {signal: abortController.signal}).then((response)=>{
      setTotalSupplier(response.data.TotalSupplier);
    });
  }
  const fetchVerify= async () => {
    await Axios.get(`${api}/api/reports/get/verify`, {signal: abortController.signal}).then((response)=>{
  ...
  const fetchTotalPO = async () => {
    await Axios.get(`${api}/api/reports/get/total/po`, {signal: abortController.signal}).then((response)=>{
      setTotalPO(response.data.TotalPO);
    });
  }

  const fetchTotalGRPO = async () => {
    await Axios.get(`${api}/api/reports/get/total/grpo`, {signal: abortController.signal}).then((response)=>{
      setTotalGRPO(response.data.TotalGRPO);
    });
  }

  const fetchTotalAP = async () => {
    await Axios.get(`${api}/api/reports/get/total/apinvoice`, {signal: abortController.signal}).then((response)=>{
