...
const Inventory = () => {
  ...
  const importExceltoDB =(e) =>{
    ...
    Axios.post("http://localhost:3001/api/importfromExl/insertExl",{
      data:data
    })
    ...
    //     data: data
    //   }).then(() => {
    //     console.log('Data added successfully to add brands');
    //   }).catch((err) => {
    //     //alert(err.response.data);
    //     console.log('Data added fails to add brands');
    //     return;
    //   });

    //   //for adding AttributeName
    //   Axios.post('http://localhost:3001/api/attribute/insertExl', {
    //     data: data
    //   }).then(() => {
    //     console.log('Data added successfully to add attributesName');
    //   }).catch((err) => {
    //     //alert(err.response.data);
    //     console.log('Data added fails to add attributesName');
    //     return;
    //   });

    //   Axios.post('http://localhost:3001/api/category/insertExl', {
    //     data: data
    //   }).then(() => {
    //     console.log('Data added successfully to add category');
    //   }).catch((err) => {
    //     //alert(err.response.data);
    //     console.log('Data added fails to add category');
    //     return;
    //   });
    
    
    // Axios.post('http://localhost:3001/api/attrvalue/insertExl', {
    //     data: data
    //   }).then(() => {
    //     console.log('Data added successfully to add attrValue');
    //   }).catch((err) => {
    //     //alert(err.response.data);
    //     console.log('Data added fails to add attrValue');
    //     return;
    //   });

    //   Axios.post('http://localhost:3001/api/supplier/insertExl', {
    //     data: data
    //   }).then(() => {
    //     console.log('Data added successfully to add supplier');
    //   }).catch((err) => {
    //     //alert(err.response.data);
    //     console.log('Data added fails to add supplier');
    //     return;
    //   });

    // Axios.post('http://localhost:3001/api/products/insertExl', {
    //     data: data
    //   }).then(() => {
    //     console.log('Data added successfully to add products');
    //   }).catch((err) => {
    //     //alert(err.response.data);
    //     console.log('Data added fails to add products');
    //     return;
    //   });
    ...
    //     data: data
    //   }).then(() => {
    //     console.log('Data added successfully to add inventory');
    //   }).catch((err) => {
    //     //alert(err.response.data);
    //     console.log('Data added fails to add inventory');
    //     return;
    //   });
  ...
  const importExcel = (e) => {
    ...
    if(e.target.files[0]===null){
      ...
      reader.onload = (event) => {
        ...
        console.log(data[0].productAttrValue + " "+data[0].productAttribute);
