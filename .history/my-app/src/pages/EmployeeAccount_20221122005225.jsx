  ...
  <Modal title={modal.Title} visible={modal.Visible} onOk={handleOk} onCancel={handleOk}
                  ...
                  <div className='flex flex-col gap-4'>
                    <div>
                      ...
                      <Input className='rounded-sm' value={ ''} placeholder="Category Name"
                        onChange={(e) => {
          ...
          <div className='m-2 my-auto bg-white rounded overflow-auto'>
            <Table bordered className='mt-14' columns={brandTblGrid} dataSource={EmpList} onChange={onChange}></Table>
          </div>
