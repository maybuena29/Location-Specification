          ...
          <div className='flex flex-col md:flex-row w-full min-w-screen justify-center items-center'>
            ...
            <div className="flex md:mr-10  flex-col gap-4 justify-center w-full md:w-1/2 p-0 sm:w-full">
                ...
                <div className="flex textboxes w-full">
                    ...
                    <Select showSearch={true} className='w-full rounded-sm' value={productAttribute || "Choose Attribute"} defaultValue="Choose Attribute" placeholder="Choose Size" 
                ...
                <div className="flex textboxes w-full">
                    ...
                    <Select showSearch={true} className='w-full rounded-sm' defaultValue="Choose Attribute Value" value={productAttrValue || "Choose Attribute Value"} placeholder="Choose Unit" onChange={(value) => { setPAttrValue(value); }} disabled={productAttribute === 0 ? true : false} >
