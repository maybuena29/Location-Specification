...
function insertDataExl(req, res){
    ...
    console.log(ExcelData.productName);

    db.query(sqlInsert,[
        ExcelData.map(datas=>[ExcelData.productName,ExcelData.productDescription,ExcelData.productAttribute,ExcelData.productAttrValue,ExcelData.productPrice,ExcelData.productCategory,ExcelData.productBrand,
            ExcelData.productSupplier,ExcelData.productSKU,ExcelData.productReqPres ])
    ],(err)=>{
        console.log(err);
    })
}
