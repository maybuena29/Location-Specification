...
async function insertData(req, res){
    var obtainedproductImageName;
    if (!req.file){
        obtainedproductImageName = null;
    }
    else{
        obtainedproductImageName = productImageName;
    }
    ...
    obtainedproductImageName=ImageAdd  
    }

        const productImageName = await productImage();
        console.log(ImageAdd)
       
    //console.log(await productImage());
    ...
    db.query(sqlInsert, [obtainedproductImageName,productName, productDescription, productAttribute, productAttrValue, productPrice,productCategory,
