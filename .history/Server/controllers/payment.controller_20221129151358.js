    ...
    db.query(sqlInsert, [RefNumber, CustCode, PaymentMode, AmountPaid, TotalChange, Status], (err, result) => {
        ...
        res.send(result);
            logs={
                ...
                AuditModule:"POS-Payment",
                AuditAction:`New Payment from ${CustCode}:${RefNumber} (${CustCode})  `
            }
            audit.logger(logs);
