...
function AddfromExcel(req, res){
        await insertDataExlAttr();
        await insertDataExlAttrV();
        await insertDataExlBrnd();
        await insertDataExlCateg();
        await insertDataExlSupp();
        async insertDataExlProd();
        async insertDataExlInv();
}

module.exports=AddfromExcel:AddfromExcel
