...
function insertDataExl(req, res){
    ...
    db.query(sqlInsert,[
        ExcelData.map(datas=>[ExcelData[datas.index].productName,ExcelData.productDescription,ExcelData.productAttribute,ExcelData.productAttrValue,ExcelData.productPrice,ExcelData.productCategory,ExcelData.productBrand,
