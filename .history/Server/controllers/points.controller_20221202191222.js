...
function displayData(req, res){
    const sqlSelect = "SELECT `PntCustID`, `CustCode`, (SELECT CustName FROM tblcustomer WHERE CustCode =CP.CustCode) AS CustName, (SELECT Contact FROM tblcustomer WHERE CustCode = CP.CustCode) AS Contact, `TotalPurchased`, `TotalPoints`, `LastUpdate` FROM `tblcustomerpoints` CP";
...
function insertData(req, res){
    ...
    const sqlInsert = "INSERT INTO `tblcustomerpoints`(`CustCode`, `TotalPoints`) VALUES (?, ?) ON DUPLICATE KEY UPDATE `TotalPoints` = (`TotalPoints` + ?)";
