...
function insertDataExl(req, res){
    ...
    const sqlInsert = "INSERT IGNORE INTO tblattributesvalue (Value_Name, Attr_Parent_ID, ValStatus) Values(?,(SELECT Attr_ID FROM tblattributes WHERE Attribute_Name ='Unit'),?)";
