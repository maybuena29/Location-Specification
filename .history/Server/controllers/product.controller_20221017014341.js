        ...
        if (err instanceof multer.MulterError) {
            ...
            async function getBrandName(){
             ...
             async function getProductName(){
                async function query(){
                     return new Promise((resolve, reject)=>{
                         db.query("SELECT productName FROM tblproducts WHERE productID = ?",[productName],(err,result)=>{
                            if (err) {
                                 reject(err);
                                 console.log(err);
                                   }
             ...
             async function getAttrValue(){
                async function query(){
                     return new Promise((resolve, reject)=>{
                         db.query("SELECT Value_Name FROM tblattributesvalue WHERE ValueID = ?",[productName],(err,result)=>{
                            if (err) {
                                 reject(err);
                                 console.log(err);
                                   }
