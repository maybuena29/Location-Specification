...
reportsRoute.get('/api/reports/get/supplier/daily/data',  reportCtrl.dailyEarnings);
reportsRoute.get('/api/reports/get/supplier/weekly/data',  reportCtrl.weeklyEarnings);
reportsRoute.get('/api/reports/get/supplier/monthly/data',  reportCtrl.monthlyEarnings);
reportsRoute.get('/api/reports/get/supplier/yearly/data',  reportCtrl.yearlyEarnings);
