                          ...
                          <div className='aboutInfo-container'>
                            <Row>
                              ...
                              <Col md={10} lg={10} className='p-6'>
                                ...
                                Corumed Pharmacy is a drug store which provides branded and generic medicines for the people. This drug store is located at 35 Corumi Street Barangay Masambong Quezon City. Owned by Jicah Mae Lumbao. Established on Febuary 01, 2019
                                </p>
                              </Col>
                              </center>
                            </Row>
...
<p className=' privacy-txt'> In Short: We process your information to provide, improve, and administer our Services and communicate with you.
We process your personal information for a variety of reasons, depending on how you interact with our Services, including:
                            ...
                            <p className='text-xl privacy-txt'>3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</p>   
                            <p className='privacy-txt'> We never share your information to any third parties. </p>
                            <p className='text-xl privacy-txt'>4. DO WE MAKE UPDATES TO THIS NOTICE?  </p>       
                            <p className=' privacy-txt'>In Short: Yes, we will update this notice as necessary. </p>     
                            <p className=' privacy-txt'>We may update this privacy notice from time to time. The updated version will be indicated by an updated "Revised" date and the updated version will be effective as soon as it is accessible. If we make material changes to this privacy notice, we may notify you either by prominently posting a notice of such changes or by displaying a notice on our Image carousel. We encourage you to review this privacy notice frequently to be informed of how we are protecting your information. </p> 
                            <p className='text-xl privacy-txt'>5. HOW CAN YOU CONTACT US ABOUT THIS NOTICE? </p>       
                            <p className=' privacy-txt '>If you nave questions or comments about this notice, you may email us at jicah04@gmail.com or by post to:</p>
                            <p className=' privacy-txt-info my-0 ml-5'>CoruMed Pharmacy</p>
                            <p className=' privacy-txt-info my-0 ml-5'>35 Corumi Street Masambong</p>
                            <p className=' privacy-txt-info my-0 ml-5'>Quezon City, Metro Manila</p>
                            <p className=' privacy-txt-info my-0 ml-5'>Philippines</p>               
