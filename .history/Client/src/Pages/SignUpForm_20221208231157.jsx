                ...
                <div className="wrap d-md-flex lg-flex">
                    ...
                    <div className="p-4 p-md-5">
                        ...
                        <Form onSubmit={handleSignIn}>
                            ...
                            <p className='w-full p-2 text-center text-white'>By clicking this button, you agree to our <a style={{textDecoration: 'inherit'}} className='text-white hover:text-blue-500' href='/TermsAndCondition'>Terms and Privacy Policy</a></p>
                            <iframe src='/TermsAndCondition' />
