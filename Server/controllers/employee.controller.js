...
function displayData(req, res){
    const sqlSelect = "SELECT E.userID,E.userUsername,(SELECT userRolename FROM tbluserroles WHERE userRoleID = E.userRoleID) AS `userRoleID`,E.userName,E.userContact,E.userAddress,E.userStatus from tblusers E INNER JOIN tbluserroles R ON E.userRoleID = R.userRoleID WHERE E.userRoleID >=1";
